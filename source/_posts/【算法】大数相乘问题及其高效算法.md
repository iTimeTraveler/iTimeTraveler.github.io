...
这里的n是数字的位数。如果是偶数，则a和b都是`n/2`位的。如果n是奇数，则你可以让a是`n/2+1`位，b是`n/2`位。（例如a = 12，b = 34；a = 123，b = 45），那么`x*y`就变成了：
...
& z_1 = (12 + 345) × (6 + 789) − z_2 − z_0 = 283815 − 72 − 272205 = 11538 \\
\end{align*}
$$
{% endraw %}
...
- [Toom-Cook 3-Way Multiplication from GMP Documentations](https://gmplib.org/manual/Toom-3_002dWay-Multiplication.html)
